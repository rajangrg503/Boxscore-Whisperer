...
When unchecked (default), behavior is unchanged from before -- still
blended with the season average using the normal shrinkage_k default.

Usage:
    python3 patch_raw_baseline_toggle.py
